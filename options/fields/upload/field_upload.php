<?php
class Simple_Options_upload extends Simple_Options{	
	...
	*/
	function render(){
		...
		//if($this->value != ''){
			echo '<img class="simple-options-screenshot" id="simple-options-screenshot-'.$this->field['id'].'" src="'.$this->value.'" />';
		//}
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			'simple-options-field-upload-js', 
			SOF_OPTIONS_URL.'fields/upload/field_upload.js', 
		...
		wp_localize_script('simple-options-field-upload-js', 'sof_upload', array('url' => $this->url.'fields/upload/blank.png'));
