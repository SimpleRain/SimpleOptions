jQuery(document).ready(function(){
	...
	jQuery('.simple-options-upload').click(function() {
		header_clicked = true;
	...
	jQuery('.simple-options-upload-remove').click(function(){
		$relid = jQuery(this).attr('rel-id');
		jQuery('#'+$relid).val('');
		jQuery(this).prev().fadeIn('slow');
		jQuery(this).prev().prev().fadeOut('slow', function(){jQuery(this).attr("src", sof_upload.url);});
