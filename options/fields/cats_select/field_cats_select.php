<?php
class Simple_Options_cats_select extends Simple_Options{	
	...
	*/
	function render(){
		...
		if (!empty($cats)) {		
			echo '<select id="'.$this->field['id'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].']" class="sof-select-item'.$class.'" style="min-width:30%">';
			foreach ( $cats as $cat ) {
