...
if ( ! class_exists( 'Simple_Options' ) ) {
	class Simple_Options {
		...
		function init() {
			...
			$this->sections = apply_filters('simple_options_filter_sections', $this->sections);	
			$this->extra_tabs = apply_filters('simple_options_filter_tabs', $this->extra_tabs);	
	...
	*/
	...
	function Simple_Options( $sections = array(), $args = array(), $tabs = array()) {
		Simple_Options::$instance->sections( $sections );
		if ( $args ) {
			Simple_Options::$instance->args( $args );	
		}
		if ( $tabs ) {
			Simple_Options::$instance->extra_tabs( $tabs );	
		}
	} // function
} // if
